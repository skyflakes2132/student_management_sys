...
public class BaView {
    ...
    @FXML
    private TableView<StudentList> BATableView;
    ...
    public void initialize() {
        ...
        BATableView.setItems(filteredStudents);
    ...
    private void loadDataFromDatabase() {
        ...
        String query = "SELECT id, school_id_number, student_name, course, year_level FROM ba_student_list";
