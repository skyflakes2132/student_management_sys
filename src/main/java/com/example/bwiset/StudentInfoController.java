...
public class StudentInfoController {
    ...
    @FXML
    public void switchToGrade(ActionEvent event) throws IOException {
        switchScene("view-grades.fxml", viewGradeButton, event);
    }

    @FXML
    public void switchToSubject(ActionEvent event) throws IOException {
        switchScene("view-subject.fxml", viewSubjectButton, event);
    }
}
